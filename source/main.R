...
# google sheet ids voor de sleutels (https://drive.google.com/drive/folders/1zAjO1kQaZEYxD7J7DgtYejPjftQ-7du2)
sleutel_df <- tribble(
  ~habitat, ~sheet_id, ~afkorting,
  "bos", "11_sh5YYlc5RFY8v7ECecAlm-4Euo_4ph2CfIPWb6CBw", "bos",
  # "grasland", "1dgSVnJBSMm4G4nPNriDzfB1XhyV0xfo-1yqcgjWwr20", "grl", (origineel)
  "grasland", "19Zcw3S4RI70vkdzFoHJC86JoMRVXf6u2qrNwbTDKrzE", "grl", # kopie PV
